...
public class SystemTabPanel extends JPanel implements SystemInterface, Observer {
    ...
    private DeveloperTabPanel tabDev;
    ...
    private void init() {
        ...
        CustomListPanel developerList = new CustomListPanel(devList, listDevBtn);
        CustomListPanel projectList = new CustomListPanel(prjList, listPrjBtn);
        /*
